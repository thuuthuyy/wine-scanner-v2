...
# Cập nhật đường dẫn đúng đến file mô hình
CLIP_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../pretrained/clip'))

# Nếu đường dẫn trên không tồn tại, thử đường dẫn khác
if not os.path.exists(CLIP_PATH):
    CLIP_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../Data/pretrained/clip'))

assert os.path.exists(CLIP_PATH), f"Error: {CLIP_PATH} does not exist"
